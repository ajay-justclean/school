...
dotenv.config();
let env = process.env.APP_ENVIRONMENT;
...
const sendGridConfig = require('./config/send-grid.config')[env];
...
module.exports = {
  ...
  // A path to a module which exports an async function that is triggered once before all test suites
   ...
   displayName: {name: 'Partner', color: 'green'},
